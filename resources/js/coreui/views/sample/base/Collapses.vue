          ...
          <b-card header-tag="header" footer-tag="footer">
            <div slot="header">
              ...
              <div class="card-actions">
                <a href="https://bootstrap-vue.js.org/docs/components/collapse" target="_blank">
        ...
        <b-col cols="12" md="6">
          <b-card header-tag="header" footer-tag="footer">
            <div slot="header">
              ...
              <strong>Collapse</strong>
              <small>
                <code>accordion</code> support
              </small>
            </div>
            <div role="tablist">
              <b-card no-body class="mb-1">
                <b-card-header header-tag="header" class="p-1" role="tab">
                  <b-btn v-b-toggle.accordion1 block href="#" variant="info">Accordion 1</b-btn>
                </b-card-header>
              ...
              <b-card no-body class="mb-1">
                <b-card-header header-tag="header" class="p-1" role="tab">
                  <b-btn v-b-toggle.accordion2 block href="#" variant="info">Accordion 2</b-btn>
                </b-card-header>
              ...
              <b-card no-body class="mb-1">
                <b-card-header header-tag="header" class="p-1" role="tab">
                  <b-btn v-b-toggle.accordion3 block href="#" variant="info">Accordion 3</b-btn>
                </b-card-header>
