...
<head>
    ...
    <meta name="theme-color" content="#E6ECED">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ config('app.name', 'LDC') }}</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=Fira+Sans:300,400,600" rel="stylesheet" type="text/css">
